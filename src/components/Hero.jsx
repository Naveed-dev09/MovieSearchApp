  ...
  return (
    <>
      ...
      <div className=' flex  flex-col gap-2 mt-0 space-y-2 p-4 lg:gap-5 lg:mt-6 md:p-4 md:mx-8 mx-4    '>
        ...
        <div><button className='py-1 px-2 lg:py-2 lg:px-4 lg:text-sm font-semibold font-sans mt-4 shadow-sm  text-xs rounded-sm border-l-2 border-r-2 border-red-500'>Explore Now</button> </div>
